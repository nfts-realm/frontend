  ...
  return (
    <footer className="footer">
      <div className="container">
        <div className="row">
          <div className="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 order-4 order-md-1 order-lg-1">
          ...
          <div className="col-6 col-md-3 col-xl-4 order-1 order-md-2 order-lg-2 offset-lg-0">
            <h6 className="footer__title">Marketplace</h6>
            <div className="footer__nav">
              <Link to="/explore">Explore</Link>
              <Link to="/creators">Creators</Link>
              <a href="/assets/terms/Website General Terms of Use(1).pdf" target="_blank" rel="noreferrer">
                Website General Terms of Use
              </a>
              <a href="/assets/terms/WebsitePrivacyPolicy.pdf" target="_blank" rel="noreferrer">
                Privacy Policy
              </a>
            </div>
          </div>
          ...
          <div className="col-6 col-md-3 col-xl-4 order-2 order-md-4 order-lg-4">
            <h6 className="footer__title">Resources</h6>
            <div className="footer__nav">
              <a href="/assets/terms/WhitePaper.pdf" target="_blank" rel="noreferrer">
                White Paper
              </a>
              {/* <a
          ...
          <div className="col-12">
            <div className="footer__content">
              <div className="footer__social">
                <span className="text-white mr-3">Contact: nftsrealm@gmail.com</span>

                <a href="https://www.instagram.com/nftsrealm/" target="_blank" rel="noreferrer">
                ...
                <a href="https://mobile.twitter.com/nftsrealm" target="_blank" rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path d="M22,5.8a8.49,8.49,0,0,1-2.36.64,4.13,4.13,0,0,0,1.81-2.27,8.21,8.21,0,0,1-2.61,1,4.1,4.1,0,0,0-7,3.74A11.64,11.64,0,0,1,3.39,4.62a4.16,4.16,0,0,0-.55,2.07A4.09,4.09,0,0,0,4.66,10.1,4.05,4.05,0,0,1,2.8,9.59v.05a4.1,4.1,0,0,0,3.3,4A3.93,3.93,0,0,1,5,13.81a4.9,4.9,0,0,1-.77-.07,4.11,4.11,0,0,0,3.83,2.84A8.22,8.22,0,0,1,3,18.34a7.93,7.93,0,0,1-1-.06,11.57,11.57,0,0,0,6.29,1.85A11.59,11.59,0,0,0,20,8.45c0-.17,0-.35,0-.53A8.43,8.43,0,0,0,22,5.8Z" />
                  </svg>
                </a>

                <a href="https://t.me/NFTsRealmOfficial" target="_blank" rel="noreferrer">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
              ...
              <small className="footer__copyright">© 2021 Corp. All Rights Reserved. </small>
            </div>
          </div>
        </div>
      </div>
