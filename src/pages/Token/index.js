        ...
        <div className="row row--grid">
          ...
          <div className="col-12 col-xl-11">
            <div className="main__title main__title--page">
              ...
              <p>
                Many desktop publishing packages and <a href="/">web page</a> editors now use Lorem Ipsum as their
              ...
              <p>
                All the Lorem Ipsum generators on the <b>Internet</b> tend to repeat predefined chunks as necessary,
          ...
          <div className="row">
            <div className="col-12 col-lg-8 col-xl-8">
              <div className="main__title">
                ...
                <a href="https://vimeo.com/45830194" className="main__video open-video">
                  Watch video
                </a>
              </div>
            </div>
