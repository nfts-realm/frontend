...
function AuthorPage() {
  ...
  const [imageCover, setImageCover] = useState(DEFAULT_COVER_IMAGE);
  ...
  const getProfile = async () => {
    ...
    if (!userProfile)
      userProfile = {
        ...
        imageCover: DEFAULT_COVER_IMAGE,
        firstName: "",
        lastName: "",
  ...
  const saveProfile = async () => {
    ...
    try {
      ...
      if (imageCover !== user.imageCover && coverFile) {
        const uploadCoverTask = await storage.ref(`/covers/${account}`).put(coverFile);
        ...
        <div className="row row--grid">
          ...
          <div className="col-12 col-xl-9">
            ...
            <div className="tab-content">
              <div className="tab-pane fade show active" id="tab-collection" role="tabpanel">
                <div className="row row--grid">
                  {cards.map((card, index) => (
                    <div className="col-12 col-sm-6 col-lg-4" key={`card-collection-${index}`}>
              ...
              <div className="tab-pane fade" id="tab-sale" role="tabpanel">
                <div className="row row--grid">
                  {saleCards.map((card, index) => (
                    <div className="col-12 col-sm-6 col-lg-4" key={`card-sale-${index}`}>
                      <Card data={card} id={card.id} />
                    </div>
                  ))}
                </div>
              ...
              <div className="tab-pane fade" id="tab-created" role="tabpanel">
                <div className="row row--grid">
                  {createdCards.map((card, index) => (
                    <div className="col-12 col-sm-6 col-lg-4" key={`card-created-${index}`}>
                      <Card data={card} id={card.id} />
                    </div>
                  ))}
                </div>
              ...
              <div className="tab-pane fade" id="tab-likes" role="tabpanel">
                <div className="row row--grid">
                  {likesCards.map((card, index) => (
                    <div className="col-12 col-sm-6 col-lg-4" key={`card-likes-${index}`}>
                      <Card data={card} id={card.id} />
                    </div>
                  ))}
                </div>
              ...
              <div className="tab-pane fade" id="tab-setting" role="tabpanel">
                <div className="row row--grid">
                  {/* details form */}
                  <div className="col-12">
                    <form action="#" className="sign__form sign__form--profile">
                      <div className="row">
                        <div className="col-12 sign__cover">
                          <img src={imageCover ? imageCover : "/assets/img/bg/bg.png"} alt="" onClick={updateCover} />
                        </div>
                        ...
                        <div className="col-12 sign__btn__group">
                          <button className="sign__btn" type="button" disabled={isProcessing} onClick={saveProfile}>
                            {isProcessing ? "Wait..." : "Save"}
                          </button>
                          <button className="sign__btn sign__btn--cancel" type="button" onClick={resetProfile}>
                            Cancel
                          </button>
                        </div>
                      </div>
