...
import AudioImage from "components/Card/AudioImage";
import VideoImage from "components/Card/VideoImage";
import "./style.css";

function AssetItem(props) {
  const isCss = props.isCss;
  const { type, image, audio, likes, creator, owner, id, imageAttach, time, auctionCreator } = props.data;
  ...
  return (
    <div className="asset__item">
      ...
      <div>
        {imageAttach && (
          <div className="asset__lock" data-tip="This NFT Contains Unlockable Content" data-effect="solid">
